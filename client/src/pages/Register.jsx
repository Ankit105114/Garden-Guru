...
import { Mail, Lock, User, Leaf, Sparkles } from 'lucide-react';
    ...
    return (
        <div className="min-h-screen relative overflow-hidden flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            ...
            <div className="absolute inset-0 z-0">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-br from-green-900/70 via-green-800/60 to-emerald-700/70 backdrop-blur-sm"></div>
            </div>
            ...
            <div className="relative z-10 max-w-md w-full">
                <div className="bg-white/10 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 p-8 md:p-10">
                    ...
                    <div className="text-center mb-8">
                        <h2 className="text-3xl font-bold text-white mb-2">Join GardenGuru</h2>
                        <p className="text-green-100">Create your account and start growing</p>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <User className="text-green-200" size={20} />
                                </div>
                                <input
                                    name="name"
                                    type="text"
                ...
                <p className="mt-6 text-center text-sm text-white/80">
                    Join thousands of plant lovers growing their gardens with GardenGuru
                </p>
            </div>
        </div>
    );
